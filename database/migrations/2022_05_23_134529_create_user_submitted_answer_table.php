...
class CreateUserSubmittedAnswerTable extends Migration
{
    public function up(){
        Schema::create('user_submitted_answer', function (Blueprint $table) {
            $table->id();
    ...
    public function down(){
        Schema::dropIfExists('user_submitted_answer');
    }
}
