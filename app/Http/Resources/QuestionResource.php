...
class QuestionResource extends JsonResource
{
    ...
    public function __construct($resource, $isSubmitted,$UserSubmittedAnswerID)
    {
        ...
        $this->UserSubmittedAnswerID = $UserSubmittedAnswerID;
    }
    ...
    public function toArray($request)
    {
        return [
            ...
            'userSubmittedAnswerID' => $this->UserSubmittedAnswerID,
