                ...
                <div class="card card-flush py-0">
                    <div class="card-body pt-0">
                        <div class="d-flex flex-column gap-5 mt-5">                                            
                            ...
                            <div class="fv-row fl">
                                <label class="form-label" for="brand">{{ __('brand.title') }}</label>                                
                                <div class="text-success">{{ $row->brand->title }}</div>
                                <input type="hidden" name="brand_id" value="{{ $row->brand_id}}">
                            </div>
                            <div class="fv-row fl">
                                <label class="required form-label" for="title">{{ __('group.title')}}</label>
                                                ...
                                                <td>
                                                    <div class="form-check form-check-solid form-check-custom form-switch">
                                                        <input class="form-check-input w-30px h-20px check" type="checkbox" name="question_id[]"
                                                            ...
                                                            @if(in_array($question->id,$row->questions->pluck('id')->toArray())) checked @endif
                                                            >
